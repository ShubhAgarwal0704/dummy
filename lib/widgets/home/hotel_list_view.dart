...
class _HotelListViewState extends State<HotelListView> {
  void addOrRemoveFromFavorites(Hotel hotel) {
    bool isFavoured =
        Provider.of<Favorites>(context, listen: false).hotelIsFavorite(hotel);
    if (!isFavoured) {
                                            ...
                                            children: <Widget>[
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Text(
                                                      '${widget.hotelData!.dist.toStringAsFixed(1)} km to College',
                                                      overflow:
                              ...
                              child: Consumer<Favorites>(
                                  builder: (context, value, child) => Material(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () => addOrRemoveFromFavorites(
                                              widget.hotelData!),
                                          child: Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Icon(
                                              !value.hotelIsFavorite(
                                                      widget.hotelData!)
